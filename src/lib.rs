...
trait Platform {
    fn setup() -> Self;
    fn notify(msg_title: &str, msg_body: &str) -> Result<(), Box<dyn Error>>;
    fn teardown(self);
}
...
impl Platform for Windows {
    ...
    fn notify(msg_title: &str, msg_body: &str) -> Result<(), Box<Error>> {
...
pub fn notify(msg_title: &str, msg_body: &str) -> Result<(), Box<dyn Error>> {
